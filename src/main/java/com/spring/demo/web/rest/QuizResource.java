...
import com.spring.demo.web.rest.errors.BadRequestAlertException;
...
public class QuizResource {
    ...
    public ResponseEntity<User> createQuiz(@Valid @RequestBody QuizDTO quizDTO) throws URISyntaxException {
